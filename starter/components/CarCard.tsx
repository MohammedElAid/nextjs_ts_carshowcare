...
/**
 * Renders a card component for a car.
 * @param {CarCardProps} car - The car object containing details like city_mpg, year, make, model, transmission, and drive.
 * @returns {JSX.Element} The car card component.
 */
function CarCard({car}:CarCardProps) {
    ...
    // State for managing the card's open state
            ...
            <div className='relative flex w-full mt-2'>
                <div className='flex group-hover:invisible w-full justify-between text-gray'>
                    <div className='flex flex-col justify-center items-center gap-2'>
                        <Image src='/Hero.png' alt='steering-wheel' width={20} height={20}/>
